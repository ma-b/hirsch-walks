...
The goal of *Spindles.jl* is to provide a lightweight interface for representing and analyzing [polytopes](https://en.wikipedia.org/wiki/Polytope).
...
To install the latest stable version of *Spindles.jl*, clone the parent [GitHub repository](https://github.com/ma-b/hirsch-walks) by running 
    ...
    git clone --branch v0.4.2 https://github.com/ma-b/hirsch-walks.git
